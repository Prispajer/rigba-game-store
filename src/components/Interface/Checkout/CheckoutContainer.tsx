...
export default function CheckoutContainer() {
  return (
    <main className="flex items-center w-full  h-full bg-primaryColor mx-auto">
      <section className="flex  w-full max-w-[1040px] mx-auto my-[30px] px-2">
        <div className="max-w-[560px] w-full mx-[10px] mb-[30px]">
          <h2 className="text-[20px] mb-[20px] font-bold text-[#ffffff] cursor-default">
            Mój koszyk
          </h2>
        ...
        <div className="max-w-[560px] w-full mx-[10px] mb-[40px]">
