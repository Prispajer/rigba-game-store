...
import { ResetSchema } from "@/utils/schemas/user";
...
export default function ResetPasswordContainer() {
  ...
  const ResetObject = useForm<z.infer<typeof ResetSchema>>({
  ...
  async function handleFormSubmit(data: z.infer<typeof ResetObject>) {
    startTransition(() => {
      setError("");
      setSuccess("");
