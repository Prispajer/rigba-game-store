                ...
                {utilsService.searchByString(apiFiltersArray).map((filter) => (
                    ...
                    >
                        <input
                            className="flex-0"
                            type="checkbox"
                            checked={selectedFiltersId.includes(filter.id as number)}
                            onChange={() =>
                                handleFilterChange(
                                    filter.id as number,
                                    selectedFiltersId,
            ...
            >
                <div className="relative flex items-center justify-center w-full h-[55px]">
                    ...
                    <div className="absolute flex items-center h-full w-[55px] right-0 top-0">
                        <IoCloseSharp
                            onClick={() => handleHideElement(clickedModal)}
                            className="w-full"
                            size="25"
                        />
                    </div>
