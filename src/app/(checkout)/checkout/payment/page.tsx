...
export default function PaymentPage() {
    ...
    const [isPaymentIntentCreated, setIsPaymentIntentCreated] = React.useState(false);
    ...
    }, [cartProducts, clientSecret, isPaymentIntentCreated, createPaymentIntent]);
    ...
    return (
        <>
            <CheckoutStepSetter step={CheckoutStep.Payment} />
